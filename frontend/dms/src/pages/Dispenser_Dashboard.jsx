...
import DispenserSidebar from "../components/Dashboard/Dispenser/Sidebar/DispenserSidebar.jsx";
    ...
    <ColorModeContext.Provider value={colorMode}>
      <ThemeProvider theme={theme}>
        ...
        <Box display="flex" height="100vh">
          ...
          <DispenserSidebar isCollapsed={isCollapsed} setIsCollapsed={setIsCollapsed} />
