...
const PaymentList = () => {
  ...
  const handleEditPayment = (payment) => {
    ...
    setEditFormData({
      ...
      medicinesCost: payment.medicinesCost,
  ...
  const handleEditFormChange = (e) => {
    ...
    if (name === "doctorFee" || name === "medicinesCost" || name === "totalAmount") {
      ...
      setEditFormData({
        ...
        ...(name === "doctorFee" || name === "medicinesCost"
          ? {
              totalAmount: (
                parseFloat(name === "doctorFee" ? value : editFormData.doctorFee) +
                parseFloat(name === "medicinesCost" ? value : editFormData.medicinesCost)
              ).toString()
            }
          : {})
      });
  ...
  const handleUpdatePayment = async () => {
    ...
    try {
      ...
      const updateData = {
        ...
        doctorFee: parseFloat(editFormData.doctorFee),
        medicinesCost: parseFloat(editFormData.medicinesCost),
